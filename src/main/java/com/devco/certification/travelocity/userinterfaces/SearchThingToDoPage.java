...
public class SearchThingToDoPage extends PageObject {
    ...
    public static Target DATE_FROM_BUTTON;
    ...
    public static Target DATE_TO_BUTTON;
    ...
    // ACTIONS
    public static void selectedDateFromFor(String initialDate) {
        SearchThingToDoPage.DATE_FROM_BUTTON = Target.the("date from button").located(By.xpath("//button[contains(@aria-label,'" + initialDate + "')]"));
    }

    public static void selectedDateToFor(String finalDate) {
        SearchThingToDoPage.DATE_TO_BUTTON = Target.the("date to button").located(By.xpath("//button[contains(@aria-label,'" + finalDate + "')]"));
    }
}
